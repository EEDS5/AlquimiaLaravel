<template>
  ...
  <router-link class="nav-link" to="/reserva">Reserva</router-link>
                   ...
                   <router-link to="/registroMenu" class="btn btn-secondary" role="button" style="background-color: #ffffff; color: #000000; border-radius: 10px;">Gestión Menu</router-link>
